...
public class ConnectorNode extends Node<Tuple<Boolean, List<String>>> {
	...
	public ConnectorNode(Boolean isTrigger, List<String> data) {
		super(new Tuple<Boolean, List<String>>(isTrigger, (data == null) ? null : new ArrayList<String>(data)));
	}

	public ConnectorNode(Boolean isTrigger, List<String> data, Node<Tuple<Boolean, List<String>>> parentNode) {
		super(new Tuple<Boolean, List<String>>(isTrigger, (data == null) ? null : new ArrayList<String>(data)),
				parentNode);
	}
